...
@WebServlet(GeneralConstants.GET_SIMULATION_RUN_DETAILS_RESOURCE)
public class GetSimulationRunDetailsResource extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.getSimulationRunDetail(simulationId)));
    }
}
