...
@WebServlet(GeneralConstants.GET_IF_SIMULATION_ENDED_RESOURCE)
public class IsSimulationEndedServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.isEnded(simulationId)));
    }
}
