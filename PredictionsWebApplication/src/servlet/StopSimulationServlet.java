...
@WebServlet(GeneralConstants.STOP_SIMULATION_RESOURCE)
public class StopSimulationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.isStop(simulationId)));
    }
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        engine.stopSimulationBySerialNumber(simulationId);
    }
}
