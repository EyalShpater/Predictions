...
@WebServlet(GeneralConstants.GET_POPULATION_COUNT_SORTED_BY_NAME_RESOURCE)
public class GetPopulationCountServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.getPopulationCountSortedByName(simulationId)));
    }
}
