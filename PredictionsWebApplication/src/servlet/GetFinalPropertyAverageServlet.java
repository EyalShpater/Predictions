...
@WebServlet(GeneralConstants.GET_FINAL_PROPERTY_AVERAGE_RESOURCE)
public class GetFinalPropertyAverageServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.getFinalNumericPropertyAvg(entityName, propertyName, simulationId)));
    }
}
