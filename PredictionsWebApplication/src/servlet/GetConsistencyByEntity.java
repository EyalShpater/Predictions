...
@WebServlet(GeneralConstants.GET_CONSISTENCY_BT_ENTITY_RESOURCE)
public class GetConsistencyByEntity extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.getConsistencyByEntityName(simulationId, entityName)));
    }
}
