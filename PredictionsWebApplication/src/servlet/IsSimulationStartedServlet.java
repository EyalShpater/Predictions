...
@WebServlet(GeneralConstants.GET_IF_SIMULATION_STARTED_RESOURCE)
public class IsSimulationStartedServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println(new Gson().toJson(engine.hasStarted(simulationId)));
    }
}
